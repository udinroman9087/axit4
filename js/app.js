...
let card = document.querySelectorAll(".items-pricing ul")
let card_item = document.querySelectorAll(".items-pricing ul li")

for (const item_tab of card) {
   ...
   item_tab.addEventListener("click", function () {
      ...
      for (const item_content of card_item) {
         item_content.classList.remove("active")
      }
